...
Most of these come down to network reality or how lemmy serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

lemmy rate-limits like any public site. lemmy already paces
...
Where a surface is gated, lemmy reads a cookie or token you supply
...
`lemmy`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what lemmy actually did
