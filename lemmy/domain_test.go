...
// HTTP behaviour is covered in lemmy_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "lemmy://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("lemmy", "about")
	if err != nil || got.String() != "lemmy://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want lemmy://page/about", got.String(), err)
	}
}
